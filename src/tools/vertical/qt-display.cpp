...
/* Meketreve: Qt < 6.9 needs a private header for the Wayland surface; a
 * local build without qt6-base-private-dev skips it (X11 still works). */
#if QT_VERSION < QT_VERSION_CHECK(6, 9, 0) && !defined(MEKETREVE_NO_QT_PRIVATE)
