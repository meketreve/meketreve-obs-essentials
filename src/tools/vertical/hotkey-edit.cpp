...
{
	dupeIcon =
		addAction(QIcon::fromTheme("obs", QIcon(":/res/images/warning.svg")), ActionPosition::TrailingPosition);
	dupeIcon->setToolTip(
		QString::fromUtf8(obs_frontend_get_locale_string("Basic.Settings.Hotkeys.DuplicateWarning")));
...
void OBSHotkeyWidget::AddEdit(obs_key_combination combo, int idx)
{
	...
	QObject::connect(add, &QPushButton::clicked,
			 [&, CurrentIndex] { AddEdit({0, OBS_KEY_NONE}, (int)CurrentIndex() + 1); });
